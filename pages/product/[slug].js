            ...
            <div className="container px-5 py-12 mx-auto">
                ...
                <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <div className="flex">
                        ...
                        {Object.keys(variants).includes('red') && Object.keys(variants['red']).includes(size) && <button onClick={()=>{refreshVariant(size, 'red')}} className={`border-2 border-gray-300 bg-red-700 rounded-full w-6 h-6 focus:outline-none ${color === 'red'?"border-black":"border-gray-300"}`}></button>}
                    ...
                    <button onClick={()=>{buynow(slug, 1, 499, product.title, size, color)}} className="flex ml-8 text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Buy Now</button>
                    <button onClick={()=>{addToCart(slug, 1, 499, product.title, size, color)}} className="flex ml-3 text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Add to Cart</button>
                    ...
                    <div className="pin mt-6 flex space-x-2 text-lg">
                        <input onChange={onChange} type='text' placeholder='Enter your Pincode' className="rounded border-2 appearance-none border-gray-600 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base pl-3 pr-10"></input>
                    ...
                    {(!service && service !=null) && <p className='text-red-600 mt-2'>Sorry! We do not deliver on this pincode</p>}
                    {(service && service !=null) && <p className='text-green-600 mt-1'>Yay! This pincode is servicable</p>}
                </div>
                </div>
            </div>
            </section>

    ...
    return (
        <>
            ...
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                ...
                <Link href={'/login'}><a><MdAccountCircle className='h-[2rem] w-[2rem] mx-4'/></a></Link>
            ...
            <div ref={ref} className="cart absolute top-0 right-0 overflow-y-scroll transform transition-transform translate-x-full z-20">
